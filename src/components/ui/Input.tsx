      ...
      <div className="w-full flex flex-col gap-1.5">
        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            ref={ref}
            className={cn(
              'w-full bg-zinc-900/90 text-zinc-100 placeholder-zinc-500 text-sm rounded-lg border border-zinc-800 px-3.5 py-2 transition-all duration-200 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed',
              leftIcon && 'pl-10',
              rightIcon && 'pr-10',

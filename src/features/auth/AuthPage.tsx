    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col justify-center items-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md z-10 space-y-6">
        ...
        <div className="text-center space-y-2">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-900 border border-zinc-800 text-xs text-indigo-400 font-semibold mb-1 shadow-inner">
            <Sparkles className="w-3.5 h-3.5" />
            <span>KalaTrack Phase 1 OS</span>
          </div>
          <div className="flex items-center justify-center gap-2">
            <div className="w-10 h-10 rounded-xl bg-indigo-600 flex items-center justify-center font-black text-white text-xl shadow-lg shadow-indigo-950/80">
              K
            </div>
            <h1 className="text-2xl font-bold tracking-tight text-zinc-100">KalaTrack</h1>
          </div>
        ...
        {/* Card Canvas */}
        <Card className="border-zinc-800/90 bg-zinc-900/95 backdrop-blur-xl shadow-2xl p-6 sm:p-8">
          <div className="mb-5 pb-4 border-b border-zinc-800/80 text-center">
